# Generated by Django 5.0.2 on 2024-10-20 04:58
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('aplicacion_dos_api', '0002_administradores_delete_profiles'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_matricula', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('materias_impartidas', models.CharField(blank=True, max_length=255, null=True)),
                ('creation', models.DateTimeField(auto_now_add=True, null=True)),
                ('update', models.DateTimeField(blank=True, null=True)),
                ('user', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
